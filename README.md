...
| Response | Result |
|----------|--------|
| ✅ Spotted the scam | +10 points + streak bonus |
| ❌ Fell for it | Lesson + red flags explained |

## Achievements

- 🎓 First Lesson — Complete first simulation
- 🔥 On Fire — 5 correct in a row
- ⚡ Unstoppable — 10 correct in a row
- 🏆 Well Rounded — All categories completed
- 💯 Perfect 10 — 100% pass rate on 10+ sims
...
| Plan | Price | Features |
|------|-------|----------|
| Free | $0 | 1 simulation/week |
| Family | $10/month | 5 members, weekly sims, dashboard |
| Family Pro | $25/month | 10 members, daily sims |
| School | $500/year | 100 students |
| Enterprise | $5,000/year | Unlimited, white-label |
